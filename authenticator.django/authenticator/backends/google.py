...
OAuth works straightforward using anonymous configurations.
Registered applications can define settings GOOGLE_CONSUMER_KEY
...
from authenticator.backends import OpenIdAuth, ConsumerBasedOAuth, BaseOAuth2, \
...
EXPIRES_NAME = getattr(settings, 'AUTHENTICATOR_EXPIRATION', 'expires')
